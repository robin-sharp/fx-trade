...
class FxTradeRoleTest {
	...
	public void testBuySellConstructor() {
		assertEquals(FXTRADE_SUPPORT_FIND_ROLE_NAME, FXTRADE_SUPPORT_FIND_ROLE.getRoleName());
		assertEquals(FXTRADE_SUPPORT_SAVE_ROLE_NAME, FXTRADE_SUPPORT_SAVE_ROLE.getRoleName());
		assertEquals(FXTRADE_SUPPORT_DELETE_ROLE_NAME, FXTRADE_SUPPORT_DELETE_ROLE.getRoleName());
	...
	public void testShortcut() {
		assertEquals(FXTRADE_SUPPORT_FIND_ROLE, getFxTradeRole(FXTRADE_SUPPORT_FIND_ROLE_NAME));
		assertEquals(FXTRADE_SUPPORT_SAVE_ROLE, getFxTradeRole(FXTRADE_SUPPORT_SAVE_ROLE_NAME));
		assertEquals(FXTRADE_SUPPORT_DELETE_ROLE, getFxTradeRole(FXTRADE_SUPPORT_DELETE_ROLE_NAME));
