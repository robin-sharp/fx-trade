...
public class PartyRoleTest {
	...
	public void testBuySellConstructor() {
		...
		assertEquals(PARTY_INTERNAL_DELETE_ROLE_NAME, PARTY_INTERNAL_DELETE_ROLE.getRoleName());
		assertEquals(PARTY_EXTERNAL_FIND_ROLE_NAME, PARTY_EXTERNAL_FIND_ROLE.getRoleName());
		assertEquals(PARTY_EXTERNAL_SAVE_ROLE_NAME, PARTY_EXTERNAL_SAVE_ROLE.getRoleName());
	}
	...
	public void testShortcut() {
		...
		assertEquals(PARTY_INTERNAL_DELETE_ROLE, getPartyRole(PARTY_INTERNAL_DELETE_ROLE_NAME));
		assertEquals(PARTY_EXTERNAL_FIND_ROLE, getPartyRole(PARTY_EXTERNAL_FIND_ROLE_NAME));
		assertEquals(PARTY_EXTERNAL_SAVE_ROLE, getPartyRole(PARTY_EXTERNAL_SAVE_ROLE_NAME));
	}
